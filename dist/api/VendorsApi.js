...
class VendorsApi {
  ...
  */
  ...
  getVendors(callback) {
    ...
    let returnType = _GroupCollection.default;
    return this.apiClient.callApi('/vendors', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
  /**
  ...
  getVendorsSearch(opts, callback) {
    ...
    let accepts = ['application/json'];
    let returnType = _GroupCollection.default;
    return this.apiClient.callApi('/vendors/search', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null, callback);
  }
