  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('display_type')) {
        obj['display_type'] = _ApiClient.default.convertToType(data['display_type'], 'String');
      }
      ...
      if (data.hasOwnProperty('playback_url')) {
        obj['playback_url'] = _ApiClient.default.convertToType(data['playback_url'], 'String');
      }
      ...
      if (data.hasOwnProperty('share_url')) {
        obj['share_url'] = _ApiClient.default.convertToType(data['share_url'], 'String');
      }
    }
