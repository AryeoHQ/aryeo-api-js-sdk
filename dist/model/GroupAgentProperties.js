  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('brokerage_name')) {
        obj['brokerage_name'] = _ApiClient.default.convertToType(data['brokerage_name'], 'String');
      }

      if (data.hasOwnProperty('agent_license_number')) {
        obj['agent_license_number'] = _ApiClient.default.convertToType(data['agent_license_number'], 'String');
      }

      if (data.hasOwnProperty('agent_avatar')) {
        obj['agent_avatar'] = _ApiClient.default.convertToType(data['agent_avatar'], 'String');
      }
    }
...
var _default = GroupAgentProperties;
