  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('facebook_profile_url')) {
        obj['facebook_profile_url'] = _ApiClient.default.convertToType(data['facebook_profile_url'], 'String');
      }

      if (data.hasOwnProperty('instagram_profile_url')) {
        obj['instagram_profile_url'] = _ApiClient.default.convertToType(data['instagram_profile_url'], 'String');
      }

      if (data.hasOwnProperty('twitter_profile_url')) {
        obj['twitter_profile_url'] = _ApiClient.default.convertToType(data['twitter_profile_url'], 'String');
      }
      ...
      if (data.hasOwnProperty('zillow_profile_url')) {
        obj['zillow_profile_url'] = _ApiClient.default.convertToType(data['zillow_profile_url'], 'String');
      }
    }
