...
var _GroupAgentProperties = _interopRequireDefault(require("./GroupAgentProperties"));
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('social_profiles')) {
        obj['social_profiles'] = _SocialProfiles.default.constructFromObject(data['social_profiles']);
      }

      if (data.hasOwnProperty('agent_properties')) {
        obj['agent_properties'] = _GroupAgentProperties.default.constructFromObject(data['agent_properties']);
      }
      ...
      if (data.hasOwnProperty('default_order_form')) {
        obj['default_order_form'] = _OrderForm.default.constructFromObject(data['default_order_form']);
      }

      if (data.hasOwnProperty('order_forms')) {
        obj['order_forms'] = _ApiClient.default.convertToType(data['order_forms'], [_OrderForm.default]);
      }
    }
