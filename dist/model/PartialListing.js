...
var _PartialGroup = _interopRequireDefault(require("./PartialGroup"));
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('branded_url')) {
        obj['branded_url'] = _ApiClient.default.convertToType(data['branded_url'], 'String');
      }

      if (data.hasOwnProperty('square_feet')) {
        obj['square_feet'] = _ApiClient.default.convertToType(data['square_feet'], 'Number');
      }

      if (data.hasOwnProperty('bedrooms')) {
        obj['bedrooms'] = _ApiClient.default.convertToType(data['bedrooms'], 'Number');
      }

      if (data.hasOwnProperty('bathrooms')) {
        obj['bathrooms'] = _ApiClient.default.convertToType(data['bathrooms'], 'Number');
      }
      ...
      if (data.hasOwnProperty('agent')) {
        obj['agent'] = _PartialGroup.default.constructFromObject(data['agent']);
      }

      if (data.hasOwnProperty('co_agent')) {
        obj['co_agent'] = _PartialGroup.default.constructFromObject(data['co_agent']);
      }
    }
