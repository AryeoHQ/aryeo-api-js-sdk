...
export class ListingsApi {
    ...
    */
     ...
     * @callback moduleapi/ListingsApi~getListingsCallback
    ...
    getListings(opts, callback) {
      ...
      let queryParams = {
        'query': opts['query'],'per_page': opts['perPage'],'page': opts['page'],'status': opts['status'],'price': opts['price'],'bathrooms': opts['bathrooms'],'bedrooms': opts['bedrooms']
      };
      let headerParams = {
     ...
     * @callback moduleapi/ListingsApi~getListingsIdCallback
     * @param {String} error Error message, if any.
