...
export class OrdersApi {
    ...
    */
     ...
     * @callback moduleapi/OrdersApi~getOrdersCallback
     ...
     * @callback moduleapi/OrdersApi~postOrdersCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:model/OrderPostPayload} opts.body OrderPostPayload
