  ...
  describe('(package)', function() {
    describe('GroupAgentProperties', function() {
      ...
      it('should create an instance of GroupAgentProperties', function() {
        // TODO: update the code to test GroupAgentProperties
      ...
      it('should have the property brokerageName (base name: "brokerage_name")', function() {
        // TODO: update the code to test the property brokerageName
        expect(instance).to.have.property('brokerageName');
        // expect(instance.brokerageName).to.be(expectedValueLiteral);
      });

      it('should have the property agentLicenseNumber (base name: "agent_license_number")', function() {
        // TODO: update the code to test the property agentLicenseNumber
        expect(instance).to.have.property('agentLicenseNumber');
        // expect(instance.agentLicenseNumber).to.be(expectedValueLiteral);
      });

      it('should have the property agentAvatar (base name: "agent_avatar")', function() {
        // TODO: update the code to test the property agentAvatar
        expect(instance).to.have.property('agentAvatar');
        // expect(instance.agentAvatar).to.be(expectedValueLiteral);
      });
