  ...
  describe('(package)', function() {
    describe('Listing', function() {
      ...
      it('should create an instance of Listing', function() {
        // TODO: update the code to test Listing
      ...
      it('should have the property floorPlans (base name: "floor_plans")', function() {
        // TODO: update the code to test the property floorPlans
        expect(instance).to.have.property('floorPlans');
        // expect(instance.floorPlans).to.be(expectedValueLiteral);
      });

      it('should have the property propertyWebsites (base name: "property_websites")', function() {
        // TODO: update the code to test the property propertyWebsites
        expect(instance).to.have.property('propertyWebsites');
        // expect(instance.propertyWebsites).to.be(expectedValueLiteral);
      });

      it('should have the property interactiveContent (base name: "interactive_content")', function() {
        // TODO: update the code to test the property interactiveContent
        expect(instance).to.have.property('interactiveContent');
        // expect(instance.interactiveContent).to.be(expectedValueLiteral);
      });
