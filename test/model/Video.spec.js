  ...
  describe('(package)', function() {
    describe('Video', function() {
      ...
      it('should have the property displayType (base name: "display_type")', function() {
        // TODO: update the code to test the property displayType
        expect(instance).to.have.property('displayType');
        // expect(instance.displayType).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property playbackUrl (base name: "playback_url")', function() {
        // TODO: update the code to test the property playbackUrl
        expect(instance).to.have.property('playbackUrl');
        // expect(instance.playbackUrl).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property shareUrl (base name: "share_url")', function() {
        // TODO: update the code to test the property shareUrl
        expect(instance).to.have.property('shareUrl');
        // expect(instance.shareUrl).to.be(expectedValueLiteral);
      });
