  ...
  describe('(package)', function() {
    describe('PropertyDetails', function() {
      ...
      it('should create an instance of PropertyDetails', function() {
        // TODO: update the code to test PropertyDetails
      ...
      it('should have the property mlsNumber (base name: "mls_number")', function() {
        // TODO: update the code to test the property mlsNumber
        expect(instance).to.have.property('mlsNumber');
        // expect(instance.mlsNumber).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property lotAcres (base name: "lot_acres")', function() {
        // TODO: update the code to test the property lotAcres
        expect(instance).to.have.property('lotAcres');
        // expect(instance.lotAcres).to.be(expectedValueLiteral);
      });

      it('should have the property parkingSpots (base name: "parking_spots")', function() {
        // TODO: update the code to test the property parkingSpots
        expect(instance).to.have.property('parkingSpots');
        // expect(instance.parkingSpots).to.be(expectedValueLiteral);
      });

      it('should have the property yearBuilt (base name: "year_built")', function() {
        // TODO: update the code to test the property yearBuilt
        expect(instance).to.have.property('yearBuilt');
        // expect(instance.yearBuilt).to.be(expectedValueLiteral);
      });
