  ...
  describe('(package)', function() {
    describe('Image', function() {
      ...
      it('should have the property largeUrl (base name: "large_url")', function() {
        // TODO: update the code to test the property largeUrl
        expect(instance).to.have.property('largeUrl');
        // expect(instance.largeUrl).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property displayInGallery (base name: "display_in_gallery")', function() {
        // TODO: update the code to test the property displayInGallery
        expect(instance).to.have.property('displayInGallery');
        // expect(instance.displayInGallery).to.be(expectedValueLiteral);
      });
