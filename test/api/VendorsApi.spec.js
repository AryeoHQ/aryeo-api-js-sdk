    ...
    describe('VendorsApi', function() {
      describe('getVendors', function() {
        it('should call getVendors successfully', function(done) {
          ...
          instance.getVendors(function(error, data, response) {
            ...
            expect(data).to.be.a(Aryeo.GroupCollection);
      ...
      describe('getVendorsSearch', function() {
        it('should call getVendorsSearch successfully', function(done) {
          // TODO: uncomment, update parameter values for getVendorsSearch call and complete the assertions
          /*
          var opts = {};

          instance.getVendorsSearch(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
