    ...
    describe('OrdersApi', function() {
      describe('getOrders', function() {
        it('should call getOrders successfully', function(done) {
          ...
          instance.getOrders(function(error, data, response) {
            ...
            expect(data).to.be.a(Aryeo.OrderCollection);
      ...
      describe('postOrders', function() {
        it('should call postOrders successfully', function(done) {
          // TODO: uncomment, update parameter values for postOrders call and complete the assertions
          /*
          var opts = {};

          instance.postOrders(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(Aryeo.OrderResource);
